...
public class HyperChargeTileService extends TileService {
    ...
    private void toggleState() {
        ...
        String limit = mSharedPrefs.getString(Constants.KEY_HYPERCHARGE_LIMIT, Constants.CHARGE_LIMIT_67W);
        Intent serviceIntent = new Intent(this, HyperChargeService.class);

        if (newState && Constants.CHARGE_LIMIT_67W.equals(limit)) {
            Log.i(TAG, "Tile toggled ON with 67W — stopping service, kernel controls charging.");
