...
public class HyperChargeSettingsFragment extends PreferenceFragment
    ...
    private void sanitizePreferences(Context context) {
        ...
        try {
            prefs.getString(Constants.KEY_HYPERCHARGE_LIMIT, Constants.CHARGE_LIMIT_67W);
        } catch (ClassCastException e) {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (isEnabled && Constants.CHARGE_LIMIT_67W.equals(limit)) {
            Log.i(TAG, "Switch ON + 67W selected — stopping service, kernel controls charging.");
